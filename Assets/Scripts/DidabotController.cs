...
public class DidabotController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float frontRightPower = frontRightDist.Map(0,10,0.01f,1) / 1;
        float frontLeftPower = frontLeftDist.Map(0,10,0.01f,1) / 1;
        float backRightPower = backRightDist.Map(0,10,0.01f,1) / 1;
        float backLeftPower = backLeftDist.Map(0,10,0.01f,1) / 1;
